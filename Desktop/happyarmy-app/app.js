...
server.listen(portNumber, function() { //Runs the server on port 8000
    ...
    var url = 'mongodb://localhost:27017/happyArmy'; //Db name
    mongoClient.connect(url, function(err, db) { //a connection with the mongodb is established here.
        console.log("Connected to Database");

        app.get('/client.html', function(req, res) { //a request to /client.html will render our client.html page
            //Substitute the variable userId in client.html with the userId value extracted from query params of the request.
